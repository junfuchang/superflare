...
The main function of SuperFlare is very simple, and the operating scenarios it is designed for are relatively harsh, so we are **very concerned about performance**.
